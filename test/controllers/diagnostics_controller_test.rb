...
class DiagnosticsControllerTest < ActionController::TestCase
  ...
  test "should create diagnostic" do
    assert_difference('Diagnostic.count') do
      post :create, diagnostic: { comments: @diagnostic.comments, date: @diagnostic.date, transformer_id: @diagnostic.transformer_id }
    end
  ...
  test "should update diagnostic" do
    patch :update, id: @diagnostic, diagnostic: { comments: @diagnostic.comments, date: @diagnostic.date, transformer_id: @diagnostic.transformer_id }
    assert_redirected_to diagnostic_path(assigns(:diagnostic))
  end
