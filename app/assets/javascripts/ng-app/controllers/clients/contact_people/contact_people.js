Inelec
  /**
   * Main contact people controller
   * @author Joaquin Volpe <joaquin.volpe@woopasoft.com>
   */
  .controller('ContactPeopleCtrl', ['$scope', '$filter', '$stateParams', 'Restangular', 'paginatedList', function($scope, $filter, $stateParams, Restangular, paginatedList) {
    'use strict';
